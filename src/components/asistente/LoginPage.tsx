...
export default function LoginPage({ onLogin }: LoginPageProps) {
  ...
  const inputClass = "w-full bg-[#1e2330]/80 text-white placeholder-gray-500 border border-gray-700 rounded-xl py-[18px] px-[18px] focus:border-[#d4af70] focus:ring-1 focus:ring-[#d4af70] outline-none transition-all text-[15px]";
