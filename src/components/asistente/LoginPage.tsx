    ...
    <div className="relative flex min-h-screen w-full items-center justify-center bg-[#0a1526] font-sans overflow-hidden">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 
            className={`text-2xl font-light tracking-widest uppercase text-center transition-colors duration-300 ${
              isLoginHovered ? 'text-[#c5a059]' : 'text-white'
            }`}
          >
        ...
        {isRegistering && (
          <>
            ...
            >
              ...
              <button
                type="submit"
                className="w-full bg-[#c5a059]/10 text-[#c5a059] border border-[#c5a059]/30 rounded-xl py-3 font-medium hover:bg-[#c5a059]/20 transition-all mt-2"
              >
                Enviar solicitud
              </button>
            </form>
