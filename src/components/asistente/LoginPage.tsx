...
export default function LoginPage({ onLogin }: LoginPageProps) {
  ...
  const inputClass = "w-full bg-[#1e2330]/80 text-white placeholder-gray-500 border border-gray-700 rounded-xl p-4 focus:border-[#e2c792] focus:ring-1 focus:ring-[#e2c792] outline-none transition-all text-sm";
  const submitBtnClass = "w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#e2c792] via-[#e2c792] to-[#e2c792] text-[#0a1526] font-bold uppercase tracking-wider py-3 text-sm rounded-xl hover:shadow-[0_0_20px_rgba(197,160,89,0.4)] transition-all active:scale-95";
