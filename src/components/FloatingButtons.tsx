        ...
        <div className="p-8 flex flex-col items-center text-center">
          ...
          <div className="flex gap-3 w-full">
            <button
              ...
              className="flex-1 py-3 rounded-xl text-sm font-medium text-gray-300 border border-gray-700 hover:border-[#c5a059] hover:text-white hover:bg-[#c5a059]/10 hover:shadow-[0_0_15px_rgba(197,160,89,0.35)] transition-all"
            >
              Cancelar
            </button>
            <button
